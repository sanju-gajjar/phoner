      ...
      <form className="mb-4" onSubmit={e => handleSubmit(e)}>
        <div className="form-row">
          ...
          <div className="form-group col-md-5">
            ...
            <input type="text" className="form-control" name="category" placeholder="Category Name" value={product.category} onChange={e => handleChange(e)} />
          </div>
          <div className="form-group col-md-5">
            <label>Model</label>
            <input type="text" className="form-control" name="description" placeholder="Model" value={product.description} onChange={e => handleChange(e)} />
          </div>
        </div>
        <div className="form-row">
          ...
          <div className="form-group col-md-2">
            ...
            <input type="text" className="form-control" name="um" placeholder="Type" value={product.um} onChange={e => handleChange(e)} />
          </div>
